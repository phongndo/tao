...
pub const Daemon = struct {
    ...
    pub fn broadcastExitFrameLocked(self: *Daemon, item: *session.TerminalSession, seq: u64, exit_code: i32, signal_value: i32) !void {
        return stream_mod.broadcastExitFrameLocked(self, item, seq, exit_code, signal_value);
    }
    ...
    pub fn broadcastStreamFrameLocked(
        ...
        return stream_mod.broadcastStreamFrameLocked(self, item, kind, seq, payload);
    }
